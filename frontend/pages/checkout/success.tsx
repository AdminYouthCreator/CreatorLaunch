...
const CheckoutSuccessPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    checkoutAPI
      ...
      .catch(() => {
        // Stripe session lookup can fail on early setup; show success after Stripe redirects here.
        setStatus('success');
      });
  }, [session_id]);

  return (
    <StoreLayout title="Order Confirmed | CreatorLaunch">
        ...
        <div className="max-w-md mx-auto text-center px-4">
          {status === 'loading' ? (
            ...
            <>
              ...
              {status === 'error' && (
                <p className="text-sm text-yellow-700 bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-6">
                  Payment confirmation is still processing. If you paid through Stripe, your
                  order should update shortly.
                </p>
              )}
